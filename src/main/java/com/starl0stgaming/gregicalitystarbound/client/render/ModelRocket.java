...
public class ModelRocket extends AnimatedGeoModel<EntityRocket> {
    ...
    private static final ResourceLocation textureResource = new ResourceLocation(Tags.MODID, "textures/entities/drop_pod.png");
    private static final ResourceLocation animationResource = new ResourceLocation(Tags.MODID, "animations/drop_pod.animation.json");
